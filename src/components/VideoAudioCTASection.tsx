...
const accents = [
  "from-teal/24 via-background to-background",
  "from-primary/14 via-background to-background",
  "from-teal/18 via-background to-background",
];
...
const VideoAudioCTASection = () => {
  ...
  const items = t('videoAudio.cta.items', { returnObjects: true }) as Array<{
    title: string;
    description: string;
    cta: string;
    label: string;
              ...
              return (
                ...
                >
                  <div className={`relative border-b border-border bg-gradient-to-br ${accent} p-6`}>
                    <div className="rounded-[10px] border border-border bg-background p-4 shadow-sm">
                      <div className="flex items-center justify-between border-b border-border pb-3">
                        <div>
                          <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-muted-foreground">{t('videoAudio.cta.videoAnnotationFlow')}</p>
                        ...
                        <div className="relative aspect-[16/10] overflow-hidden rounded-[10px] border border-border bg-navy">
                          ...
                          <div className="absolute bottom-4 left-4 right-4 space-y-2">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                              {barWidths.map((bar, barIndex) => (
                                <div key={barIndex} className="rounded-md border border-primary-foreground/12 bg-background/10 px-2 py-2">
                  ...
                  <div className="space-y-4 p-8 text-center">
                    ...
                    <p className="text-[17px] leading-8 text-muted-foreground">{item.description}</p>
                    <a
                      href="#contact"
